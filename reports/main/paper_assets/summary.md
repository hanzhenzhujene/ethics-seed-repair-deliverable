...
- `iterative_from_seed` does not beat the fair one-shot full-budget control in this run.
...
- Not established here: superiority over the fair one-shot full-budget control.
